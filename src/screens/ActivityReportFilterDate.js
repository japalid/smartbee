        ...
        return (
            ...
            >
                <View style={styles.container}>
                    ...
                    <TouchableOpacity onPress={()=>this.props.navigation.navigate("ActivityReportFilterResult",{date_from:this.state.date,date_to:this.state.date2,id:this.props.navigation.getParam("id"),report:this.props.navigation.getParam("report")})} style={{justifyContent: 'flex-end',backgroundColor:'#0576DC',height:30,alignItems:'center'}} >

            ...
            <View>
                <ImageBackground style={styles.imageBackground} source={srcBg}>
                    <View style={{alignItems:'center',justifyContent:'center',marginTop:20}}>
                        <ImageBackground source={srcBorder} style={{width:166,height:162}}>
                            <View style={{width:166,height:162,borderRadius:80,alignItems:'center',justifyContent:'center'}}>
                                <Image source={srcFoodExample} style={{width:143,height:142,borderRadius:71}} />
                            </View>
                        </ImageBackground>
                    </View>
                    <View
                    ...
                    >
                        <Text>Date : </Text>
                        <TouchableOpacity
                            onPress={()=>this.props.navigation.navigate('FoodReportFilterDate',{id:this.props.navigation.getParam("id"),report:this.props.navigation.getParam("report")})}
                        >

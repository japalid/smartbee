...
class ScheduleInvite extends React.Component {
          ...
          <View style={styles.container}>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
              ...
              <View style={{marginLeft:15,marginRight:15}}>
                ...
                <View style={{bottom:0,position:'absolute',alignItems:'center',backgroundColor:'#EE534F',justifyContent:'center',flex:1,width:width,padding:10}}>
                    <TouchableOpacity style={{flex:1,width:width,alignItems:'center'}}>
                        <Text style={{color:'#ffffff',alignItems:'center',fontSize:15}}>DELETE</Text>
                    </TouchableOpacity>
                </View>
            </View>
      );

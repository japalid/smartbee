...
import { View, Text, Image, StyleSheet, TouchableOpacity, ImageBackground, ActivityIndicator, ScrollView } from 'react-native';
                            ...
                            <View style={{flexDirection:'row'}}>
                                ...
                                <View style={{marginLeft:25}}>
                                    ...
                                    >
                                        ...
                                        <Text style={{color:"#3D4356",fontSize:15,marginBottom:10}}>{item.mood}</Text>
